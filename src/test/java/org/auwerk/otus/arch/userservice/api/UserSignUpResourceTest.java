...
public class UserSignUpResourceTest {
    ...
    void signUp_success() {
        ...
        // when
        Mockito.when(userProfileService.createUserProfile(any(UserProfile.class), anyString()))
        ...
        Mockito.verify(userProfileService, times(1))
                .createUserProfile(argThat(profile -> USERNAME.equals(profile.getUserName())), eq(PASSWORD));
    }
}
